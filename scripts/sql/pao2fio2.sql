...
DROP TABLE IF EXISTS oxy_params CASCADE;
create table oxy_params as
with pvt as
( -- begin query that extracts the data
  ...
  -- this also fuses together multiple ITEMIDs containing the same data
    ...
    left join labevents le
      ...
      and le.charttime between co.intime and co.outtime
      and le.ITEMID in
      -- blood gases
      (
...
DROP TABLE IF EXISTS pao2fio2 CASCADE;
create table pao2fio2 as
with stg_spo2 as
(
...
DROP TABLE IF EXISTS pao2fio2peep CASCADE;
create table pao2fio2peep as
with stg_peep as
(
